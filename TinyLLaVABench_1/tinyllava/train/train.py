...
# # Add the directory containing the `llava` module to the Python path
# llava_path = '/scratch/ltl2113/LLaVA-Med/llava'
# sys.path.append(llava_path)
# # Print the current Python path
# print("Current sys.path:", sys.path)

# # Check if the llava directory exists
# print("Does the llava path exist?", os.path.exists(llava_path))

# # Check the contents of the llava directory
# if os.path.exists(llava_path):
#     print("Contents of llava directory:", os.listdir(llava_path))

import sys
import os

# Add the parent directory to sys.path to find my_script
script_dir = os.path.dirname(os.path.realpath(__file__))  # Path to the directory of other_file.py
