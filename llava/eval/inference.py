...
def eval_model(args):
    ...
    # hardcoded_question ={
    #     "question_id": 1,
    #     "text": "What is the organ in the image?\n<image>",
    ...
    # hardcoded_question ={
    #     "question_id": 1,
    #     "text": "Portray the image with a rich, descriptive narrative\n<image>",
    #     "image": "31178693_F4.jpg"  # Update this path to the actual image location
    # }
    ...
    hardcoded_question ={
        ...
        "image": "35189814_Fig2.jpg"  # Update this path to the actual image location
    }


    idx = hardcoded_question["question_id"]
    ...
    image_path = os.path.join(args.image_folder, hardcoded_question["image"])
    # Check if the image file exists
    if not os.path.exists(image_path):
        print(f"Image file does not exist: {image_path}")
       
    # Since the file exists, proceed with opening the image
    ...
    print(json.dumps(result, indent=4))  # Print the result in a nicely formatted JSON string
